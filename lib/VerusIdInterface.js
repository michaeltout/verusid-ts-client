...
class VerusIdInterface {
    ...
    // want to update.
    createUpdateIdentityTransaction(identity, changeAddress, rawIdentityTransaction, identityTransactionHeight, utxoList, chainIAddr, fee = 0.0001, fundRawTransactionResult, currentHeight, updateIdentityTransactionHex, parseVdxfObjects = true) {
        return __awaiter(this, void 0, void 0, function* () {
            let height = currentHeight;
            let chainId;
            if (height == null) {
